<div class="custom-slider">
    <div class="js_number_carousel owl-carousel">
        <div class="item">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/slider-3.jpg" alt="img3" />
        ...
        <div class="item">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/slider-2.jpg" alt="img2" />
            <div class="slider-post">
                <article class="post">
                    <div class="post-header">
        ...
        <div class="item">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/slider-4.jpg" alt="img4" />
            <div class="slider-post">
                <article class="post">
                    <div class="post-header">
        ...
        <div class="item">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/slider-1.jpg" alt="img1" />
            <div class="slider-post">
                <article class="post">
                    <div class="post-header">
